...
namespace MPMAR.Data.Migrations
{
    ...
    [Migration("20200215140610_EditForignKeyBetweenMasterTableAndVersionTableToBeNullable")]
    partial class EditForignKeyBetweenMasterTableAndVersionTableToBeNullable
    {
            ...
            modelBuilder.Entity("MPMAR.Data.NavItemVersion", b =>
                {
                    ...
                    b.HasIndex("NavItemId")
                        .IsUnique()
                        .HasFilter("[NavItemId] IS NOT NULL");
            ...
            modelBuilder.Entity("MPMAR.Data.PageRouteVersion", b =>
                {
                    ...
                    b.HasIndex("PageRouteId")
                        .IsUnique()
                        .HasFilter("[PageRouteId] IS NOT NULL");
            ...
            modelBuilder.Entity("MPMAR.Data.NavItemVersion", b =>
                {
                    ...
                    b.HasOne("MPMAR.Data.NavItem", "NavItem")
                        .WithOne("NavItemVersion")
                        .HasForeignKey("MPMAR.Data.NavItemVersion", "NavItemId")
