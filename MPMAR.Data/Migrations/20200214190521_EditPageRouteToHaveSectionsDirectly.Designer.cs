...
namespace MPMAR.Data.Migrations
{
    ...
    [Migration("20200214190521_EditPageRouteToHaveSectionsDirectly")]
    partial class EditPageRouteToHaveSectionsDirectly
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MPMAR.Data.DynamicPageContent", b =>
                {
                    ...
                    b.ToTable("DynamicPageContent");
                });

            modelBuilder.Entity("MPMAR.Data.DynamicPageContentVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DynamicPageContentVersion");
                });
            ...
            modelBuilder.Entity("MPMAR.Data.DynamicPageSectionVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DynamicPageSectionVersions");
                });
            ...
            modelBuilder.Entity("MPMAR.Data.DynamicPageContent", b =>
                {
                    b.HasOne("MPMAR.Data.ApplicationUser", "ApprovedBy")
                        .WithMany("ApprovedDynamicPageContents")
                        .HasForeignKey("ApprovedById");

                    b.HasOne("MPMAR.Data.ApplicationUser", "CreatedBy")
                        .WithMany("CreatedDynamicPageContents")
                        .HasForeignKey("CreatedById");

                    b.HasOne("MPMAR.Data.ApplicationUser", "ModifiedBy")
                        .WithMany("ModifiedDynamicPageContents")
            ...
            modelBuilder.Entity("MPMAR.Data.DynamicPageContentVersion", b =>
                {
                    b.HasOne("MPMAR.Data.ApplicationUser", "ApprovedBy")
                        .WithMany("ApprovedDynamicPageContentVersions")
                        .HasForeignKey("ApprovedById");

                    b.HasOne("MPMAR.Data.ApplicationUser", "CreatedBy")
                        .WithMany("CreatedDynamicPageContentVersions")
                        .HasForeignKey("CreatedById");

                    b.HasOne("MPMAR.Data.DynamicPageContent", "DynamicPageContent")
                        .WithMany("DynamicPageContentVersions")
            ...
            modelBuilder.Entity("MPMAR.Data.DynamicPageSection", b =>
                {
                    b.HasOne("MPMAR.Data.ApplicationUser", "ApprovedBy")
                        .WithMany("ApprovedDynamicPageSections")
                        .HasForeignKey("ApprovedById");

                    b.HasOne("MPMAR.Data.ApplicationUser", "CreatedBy")
                        .WithMany("CreatedDynamicPageSections")
                        .HasForeignKey("CreatedById");

                    b.HasOne("MPMAR.Data.DynamicPageContent", null)
                    ...
                    b.HasOne("MPMAR.Data.ApplicationUser", "ModifiedBy")
                        .WithMany("ModifiedDynamicPageSections")
                        .HasForeignKey("ModifiedById");
            ...
            modelBuilder.Entity("MPMAR.Data.DynamicPageSectionVersion", b =>
                {
                    b.HasOne("MPMAR.Data.ApplicationUser", "ApprovedBy")
                        .WithMany("ApprovedDynamicPageSectionVersions")
                        .HasForeignKey("ApprovedById");

                    b.HasOne("MPMAR.Data.ApplicationUser", "CreatedBy")
                        .WithMany("CreatedDynamicPageSectionVersions")
                        .HasForeignKey("CreatedById");

                    b.HasOne("MPMAR.Data.DynamicPageSection", "DynamicPageSection")
                        .WithOne("DynamicPageSectionVersion")
                        .HasForeignKey("MPMAR.Data.DynamicPageSectionVersion", "DynamicPageSectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MPMAR.Data.PageRouteVersion", "PageRouteVersion")
                        .WithMany("DynamicPageSectionVersions")
            ...
            modelBuilder.Entity("MPMAR.Data.PageRouteVersion", b =>
                {
                    ...
                    b.HasOne("MPMAR.Data.PageRoute", "PageRoute")
                        .WithOne("PageRouteVersion")
                        .HasForeignKey("MPMAR.Data.PageRouteVersion", "PageRouteId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
