...
{
    public class MinistryVisionController : BaseController
    {
        ...
        public MinistryVisionController(ApplicationDbContext dataAccessService, IConfiguration configuration, IPageRouteRepository pageRouteRepository)
        {
        ...
        /// <summary>
        /// get MinistryVision page index
        /// </summary>
        /// <param name="lang"></param>
        /// <returns></returns>
        public IActionResult Index(string lang)
        {
            var pageRoute = _pageRouteRepository.GetByControllerName(nameof(MinistryVisionController)[0..^10]);
