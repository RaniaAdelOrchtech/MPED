...
namespace MPMAR.Analytics.Data.Migrations
{
    ...
    [Migration("20200906185009_addGovernorateVersion")]
    partial class addGovernorateVersion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MPMAR.Analytics.Data.Models.ActivityCurrentVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("ActivityCurrentId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ActivityCurrentVersions");
                });
            ...
            modelBuilder.Entity("MPMAR.Analytics.Data.Models.GovernorateVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("GovernorateVersions");
                });

            modelBuilder.Entity("MPMAR.Analytics.Data.Models.InvestmentVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("InvestmentVersions");
                });

            modelBuilder.Entity("MPMAR.Analytics.Data.Models.RGDPGrowthRateVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("RGDPGrowthRateId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RGDPGrowthRateId");

                    b.ToTable("RGDPGrowthRateVersions");
                });

            modelBuilder.Entity("MPMAR.Analytics.Data.Models.SectorGrowthRateVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("SectorGrowthRateId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SectorGrowthRateId");

                    b.ToTable("SectorGrowthRateVersion");
                });
            ...
            modelBuilder.Entity("MPMAR.Analytics.Data.Models.ActivityCurrentVersion", b =>
                {
                    b.HasOne("MPMAR.Analytics.Data.ActivityCurrent", "ActivityCurrent")
                        .WithMany()
                        .HasForeignKey("ActivityCurrentId");
            ...
            modelBuilder.Entity("MPMAR.Analytics.Data.Models.GovernorateVersion", b =>
                {
                    ...
                    b.HasOne("MPMAR.Analytics.Data.Governorate", "Governorate")
                        .WithMany()
            ...
            modelBuilder.Entity("MPMAR.Analytics.Data.Models.InvestmentVersion", b =>
                {
                    ...
                    b.HasOne("MPMAR.Analytics.Data.Investments", "Investments")
                        .WithMany()
            ...
            modelBuilder.Entity("MPMAR.Analytics.Data.Models.RGDPGrowthRateVersion", b =>
                {
                    ...
                    b.HasOne("MPMAR.Analytics.Data.RGDPGrowthRate", "RGDPGrowthRate")
                        .WithMany()
                        .HasForeignKey("RGDPGrowthRateId");
                });
            ...
            modelBuilder.Entity("MPMAR.Analytics.Data.Models.SectorGrowthRateVersion", b =>
                {
                    ...
                    b.HasOne("MPMAR.Analytics.Data.SectorGrowthRate", "SectorGrowthRate")
                        .WithMany()
                        .HasForeignKey("SectorGrowthRateId");
                });
